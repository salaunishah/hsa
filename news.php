               ...
               <div class="row">
                  <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-1 col-lg-6 col-md-6 col-sm-10">
                     ...
                     <div class="form-group">
                      <center><span style="color: green;"><i class="fa fa-picture-o"></i> Upload News Image:</span></center><br />
                      <center><img id="ImgProductDisplayPic" src="images/DefaultProduct.jpg" alt="news" height="150px" width="220px"/></center><br /><br />
                      <center><input type='file' id="FU_ProductImage" /></center><br />
                      <center><small id="ProductImageValidate"></small></center>
                     </div>
                     <div class="form-group">
                      <a id="BtnAddNews" class="btn btn-warning"><i class="fa fa-picture-o"></i> Add News</a>
                     </div>
                  </div>
               </div>
            </div>
