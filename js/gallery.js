$(document).ready(function () {
 ...
 var TxtImageTitleFlag = false;  FileFlag = false; FileExtFlag = false; FileSizeFlag = false;
 ...
 $("#TxtImageTitle").bind("blur", function (e) {
        $("#TxtImageTitleValidate").empty();
        if ($("#TxtImageTitle").val() == "") {
            $("#TxtImageTitleValidate").html('(*) Event Image Title Required..!!');
            TxtImageTitleFlag = false;
        }
        else {
            if ($("#TxtImageTitle").val().length > 200) {
                $("#TxtImageTitleValidate").html('Invalid Image Title ..!!');
                TxtImageTitleFlag = false;
            }
            else {
                TxtImageTitleFlag = true;
            }
        }
    });
  ...
  if (FileFlag == true && FileExtFlag == true && FileSizeFlag == true && TxtImageTitleFlag == true) {
            Addgallery();
        }
        else {
            alert("Invalid Input ..!!");
 ...
 function Addgallery(){
    ...
    formData.append("title",$('#TxtImageTitle').val());
