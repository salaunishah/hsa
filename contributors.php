...
<meta name="viewport" content="width=device-width, initial-scale=1">
 ...
 <script src="js/contributor.js" type="text/javascript"></script>
                  ...
                  <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-1 col-lg-6 col-md-6 col-sm-10">
                     ...
                     <div class="form-group">
                      ...
                      <div class="input-group">
                         ...
                         <input type="text" id="name"  placeholder="Enter Name Here.." class="form-control" maxlength="200">
                      </div>
                      <small id="namevalidate"></small>
                     </div>
                      <div class="form-group">
                      <span style="color: green;"> Designation:</span><br />
                      <div class="input-group">
                         <span class="input-group-addon"><i class="fa fa-comments"></i></span>
                         <input type="text" id="designation"  placeholder="Enter Designation Here.." class="form-control" maxlength="200">
                      
                      <small id="designationvalidate"></small>
                     </div>
                     <div class="form-group">
                      <a id="BtnAddContributor" class="btn btn-warning"><i class="fa fa-picture-o"></i> Add Contributor</a>
                     </div>
                  </div>
               </div>
            </div>
